...
LOCAL_SWU_IMAGE_NAME="${DEPLOY_DIR}/${BASE_IMAGE_NAME}-swu-${MACHINE}.${SWU_IMAGE_EXTENSION}"
REMOTE_SWU_IMAGE_NAME="${BASE_IMAGE_NAME}-swu-${MACHINE}-${VERSION}.${SWU_IMAGE_EXTENSION}"
